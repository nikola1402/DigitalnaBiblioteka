...
public class IzmenaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String nazivDela = request.getParameter("nazivDela");
        ...
        conn.azuriraj(nazivDela, ime, prezime, godina, jezik, kolekcija, stamparija, mesto);
        //conn.azurirajId(id, ime, prezime, godina, jezik, kolekcija, stamparija, mesto);
